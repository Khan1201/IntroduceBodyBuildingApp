...
## 프로젝트 동기 :hammer:
> ios 개발 공부를 시작하고, 처음으로 진행한 헬스 관련 개인 프로젝트입니다. 평소 운동을 즐겨하기도 하고, 제가 직접 운동하며 `리프터`의 입장으로 현재 헬스 업계 앱 시장에 부족한 부분을 생각해 왔었습니다. 현재 서비스 중인 헬스 앱에서 제공하는 프로그램은 대부분 유료이며, 저뿐만 아니라 대부분의 헬서들이 쉽게 접근할 수 없었습니다. 다수의 많은 헬서 분들이 쉽게 접하고 즐겼으면 하는 마음에 프로젝트를 기획하게 되었습니다.

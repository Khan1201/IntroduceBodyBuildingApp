...
## 프로젝트 동기 :hammer:
> <p> ios 개발 공부를 시작하고, 처음으로 진행한 헬스 관련 개인 프로젝트입니다. </p>
> <p> 평소 운동을 즐겨하기도 하고, 제가 직접 운동하며 `리프터`의 입장으로 현재 헬스 업계 앱 시장에 부족한 부분을 생각해 왔었습니다. 현재 서비스 중인 헬스 앱에서 제공하는 프로그램은 대부분 유료이며, 저뿐만 아니라 대부분의 `헬서`들이 쉽게 접근할 수 없었습니다.</p> 
> <p> 다수의 많은 `헬서` 분들이 쉽게 접하고 즐겼으면 하는 마음에 프로젝트를 기획하게 되었습니다. </p>

<br>

## 프로젝트 소개 📝
> <p> 세계 운동학자들이 만들어낸 무료 공개 운동 프로그램을 앱에 담았습니다. 사용자는 다양한 운동 프로그램들을 볼 수 있으며, 자신의 무게를 적용하여 직접 프로그램 루틴을 체험해 볼 수 있습니다. </p>
> <p> 체험에 도움을 주기 위해, 알람 기능 및 메모 기능을 추가했습니다. 사용자는 원하는 시간대에 운동을 즐길 수 있고, 자신의 운동 수행에 관한 메모를 할 수 있습니다. </p>
> <p> 해당 프로젝트에 <b>Rx Swfit + MVVM</b> 및 다양한 오픈소스들을 활용하였습니다. </p>
